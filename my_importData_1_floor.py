...
tfit = RandomForestRegressor(100).fit(numpy_array[0:164, 0:2 ], t).predict(numpy_array[0:186, 0:2])
...
ax.errorbar(xtest, numpy_array[164:186, 3], fmt='og', label="Test traffic")
