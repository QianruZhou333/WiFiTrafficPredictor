...
tfit = RandomForestRegressor(100).fit(numpy_array[0:168, 0:2 ], t).predict(numpy_array[168:190, 0:2])
...
#ax.set_title('Taffic Prediction with Random Forest Regression on ground floor')
